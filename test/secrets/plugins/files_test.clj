(ns secrets.plugins.files-test
  (:require [clojure.string :as str]
            [clojure.test :refer [deftest is]]
            [clojure.java.io :as io]
            [secrets.plugins.files :as sut])
...
(defn tmp-dir []
  (.toFile (Files/createTempDirectory "secrets-files-test-" (make-array java.nio.file.attribute.FileAttribute 0))))
...
;; ---------- lookup: get-secret (prime via reload!)
